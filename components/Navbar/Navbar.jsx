...
const Layout = ({ children }) => (
  <nav className={styles.navbar}>
    ...
    <div className={styles.navigation}>
      <Link href="/about" passHref><span className={styles.rainbow1}>Nosotros</span></Link>
      <Link href="/contact" passHref><span className={styles.rainbow2}>Contacto</span></Link>
      ...
      <Link href="/noticias" passHref><span className={styles.rainbow7}>Noticias</span></Link>
      <Link href="/blog" passHref><span className={styles.rainbow8}>Blog</span></Link>
    </div>
  </nav>
);
